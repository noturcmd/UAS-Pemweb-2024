<html>
<head>
    <title>Hotel Ticket Booking</title>
...
<body>
    <div class="header">
        <input type="text" placeholder="Cari Hotel Terpilih">
        <nav>
            <ul>
    ...
    <div class="main">
        <img src="https://storage.googleapis.com/a1aa/image/fbnIYbaX8uR2cqfDxxxyE7xDM4Exdd84ynIV9a5ycQrm3a4TA.jpg" alt="Hotel Image">
        <div class="overlay">
            <h1>Cek Harga Hotel Online Murah dan Promo Hari Ini</h1>
            <div class="search-box">
                <div class="form-group">
                    <label for="location">Lokasi</label>
                    <input type="text" id="location" placeholder="Masukkan lokasi hotel">
                </div>
                <div class="form-group">
