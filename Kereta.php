...
<body>
    <div class="header">
        <input type="text" placeholder="Cari Tiket kereta">
        <nav>
            <ul>
                <li><a href="Hotel.php">Hotel</a></li>
                <li><a href="Travel.php">Travel</a></li>
                <li><a href="Kereta.php" class="active">Kereta</a></li>
                <li><a href="Pesawat.php">Pesawat</a></li>
            </ul>
        </nav>
    </div>
    <div class="main">
        <img src="https://storage.googleapis.com/a1aa/image/fbnIYbaX8uR2cqfDxxxyE7xDM4Exdd84ynIV9a5ycQrm3a4TA.jpg" alt="Train Image">
        <div class="overlay">
            <h1>Cek Harga Tiket Kereta Online Murah dan Promo Hari Ini</h1>
            <div class="search-box">
                <div class="form-group">
                    <label for="train-type">Pilih Kereta</label>
                ...
                <div class="form-group">
                    <label for="from-station">Dari Stasiun</label>
                ...
                <div class="form-group">
                    <label for="to-station">Ke Stasiun</label>
